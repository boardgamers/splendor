...
<style>
  ...
  .card.tier-1 { background: linear-gradient(160deg, #eef2ec 0%, #dfe7dc 55%, #cbd8c6 100%); }
  .card.tier-2 { background: linear-gradient(160deg, #f0ede2 0%, #e4ddc8 55%, #d2c8a8 100%); }
  .card.tier-3 { background: linear-gradient(160deg, #ece4da 0%, #ded0bd 55%, #c9b699 100%); }
  ...
  .card.mini .points { font-size: 14px; }
  .card.mini .bonus { width: 14px; height: 14px; }
</style>
