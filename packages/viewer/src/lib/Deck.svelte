...
<style>
  ...
  .deck.tier-1 { background: linear-gradient(150deg, #3d5a43, #2c4231); }
  .deck.tier-2 { background: linear-gradient(150deg, #6d5a2c, #4f411f); }
  .deck.tier-3 { background: linear-gradient(150deg, #5d3a4e, #452b39); }
  .roman {
    font-size: 22px;
    font-weight: 800;
    letter-spacing: 2px;
