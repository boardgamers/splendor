...
<style>
  ...
  h2 { margin: 0 0 4px; color: var(--gold); font-size: 20px; }
  .result { margin: 0 0 12px; color: var(--text); font-size: 16px; font-weight: 600; }
  table { border-collapse: collapse; width: 100%; max-width: 420px; }
  th, td { text-align: left; padding: 4px 12px 4px 0; font-size: 13px; }
  th { color: var(--text-dim); font-weight: 600; }
  tr.winner td { color: var(--gold); font-weight: 700; }
</style>
